...
package com.doomonafireball.masterbuilder.android.util;
...
public class GameHelper implements GooglePlayServicesClient.ConnectionCallbacks,
    ...
    public interface GameHelperListener {
         ...
         * clicked, call
         *
         * @link{GamesHelper#beginUserInitiatedSignIn}. Note that not all calls to this method mean an error; it may be
    ...
    /**
     * Performs setup on this GameHelper object. Call this from the onCreate() method of your Activity. This will create
     * the clients and do a few other initialization tasks. Next, call @link{#onStart} from the onStart() method of your
     * Activity.
     *
     * @param listener The listener to be notified of sign-in events.
     * @param clientsToUse The clients to use. Use a combination of CLIENT_GAMES, CLIENT_PLUS and CLIENT_APPSTATE, or
     * CLIENT_ALL to request all clients.
     * @param additionalScopes Any scopes to be used that are outside of the ones defined in the Scopes class. I.E. for
     * YouTube uploads one would add "https://www.googleapis.com/auth/youtube.upload"
     */
    ...
    /**
     * Returns the GamesClient object. In order to call this method, you must have called @link{setup} with a set of
     * clients that includes CLIENT_GAMES.
     */
    ...
    /**
     * Returns the AppStateClient object. In order to call this method, you must have called @link{#setup} with a set of
     * clients that includes CLIENT_APPSTATE.
     */
    ...
    /**
     * Returns the PlusClient object. In order to call this method, you must have called @link{#setup} with a set of
     * clients that includes CLIENT_PLUS.
     */
    ...
    /**
     * Returns the invitation ID received through an invitation notification. This should be called from your
     * GameHelperListener's
     *
     * @return The id of the invitation, or null if none was received.
     * @link{GameHelperListener#onSignInSucceeded} method, to check if there's an invitation available. In that case,
    ...
    /**
     * Returns the tbmp match received through an invitation notification. This should be called from your
     * GameHelperListener's
     *
    ...
    /**
     * Returns an array of the current requested scopes. This is not valid until setup() has been called
     *
     * @return the requested scopes, including the oauth2: prefix
     */
